...
<body>
	...
	<div class="layerMapheader">
		...
		<div id="tabs">
			<ul>
				<li class="tab labels"><a href="#tab-1">Labels</a></li>
				<li class="tab dynamic"><a href="#tab-2">Dynamic Variables</a></li>
				<li class="touchtab"><a href="#tab-3">Touch Zones</a></li>
			</ul>
			<div class="labelstab" id="tab-1"
				style="overflow: auto; height: 183px; font-weight: normal;"></div>
			<div class="dynamictab" id="tab-2"></div>
			<div id="tab-3"></div>
		</div>
		<div class="button">
			<input type="button" class="mapTermButton btn btn-default" value="Map Term"
				 /> <input type="button"
				class="saveMapping btn btn-default" value="Save Mapping" />
				<input type="button" class="newMapping btn btn-primary" value="New Mapping" style="display: none;"/>
		</div>
	</div>
	<div class="engMasterheader" style="display: block;">
		...
		<div>
			<div style="background-color: gray;">
					...
					<div style="float: left;">
						<button id="srchBtnId" onclick="javascript:void(0);">Search</button>
					</div>
					<div style="float:left;">
	...
	<div class="variableMaster" style="display: none;">
		...
		<div>
			<div style="background-color: gray;">
					...
					<div style="float: left;">
						<button id="dynamicSrchBtnId" onclick="javascript:void(0);">Search</button>
					</div>
			</div>
			<div class="englishMaster" style="float: left; width: 100%;"></div>
		</div>
